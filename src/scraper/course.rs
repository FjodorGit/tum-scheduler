...
#[derive(Debug, PartialEq, Clone, FromSqlRow, AsExpression, Eq, Serialize, Deserialize)]
...
impl Course {
    fn read_all_from_page(xml: String) -> Result<Vec<Course>, ScraperError> {
        let mut result = vec![];
...
mod test {
    ...
    use crate::scraper::course::Course;
